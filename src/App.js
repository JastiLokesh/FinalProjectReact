  ...
  return (
    <div className="home-container">
      <div className="text-container">
        <h1 className="welcome-message">Welcome to Personal Budget Application</h1>
      </div>
      <div className="image-container">
        <img
          src={process.env.PUBLIC_URL + '/personal-finance-7977144.jpg'}
          alt="Budget Website Banner"
          className="background-image"   width="200" 
          height="200" 
        />
      </div>
